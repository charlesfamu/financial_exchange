...
MyLocalStorage.prototype.setObj = function (key, obj) {
  return localStorage.setItem(key, JSON.stringify(obj));
};

MyLocalStorage.prototype.getObj = function (key) {
...
var Store = (function () {
    var Store = function (name, cb) {
       ...
       if (!localStorage[name]) {
           var data = [];
           myLocalStorage.setObj(name, data);
       }

       cb.call(this, myLocalStorage.getObj(name));
     };
     ...
     Store.prototype.update = function (data, cb) {
         ...
         var exchangeData = myLocalStorage.getObj(this.name);
         ...
         myLocalStorage.setObj(this.name, exchangeData);
         cb.call(this, exchangeData);
     };

     Store.prototype.hasData = function () {
       return myLocalStorage.getObj(this.name);
     };
